 ...
 * @returns {Proxy} 对象
 */
function store(dbName = Date.now() + '', obj: {}, config: { path: any; }) {
    ...
    function get(target: object, propKey: PropertyKey, receiver: any) {
        // console.log('get')
    ...
    function set(target: object, propKey: PropertyKey, value: any, receiver: any) {
    ...
    function deleteProperty(target: object, propKey: PropertyKey) {
        // console.log('删除')
    ...
    //方法
    function isObject(val: object | null) {
    ...
    //get 时 收集依赖
    function track(target: object, type: string, key: PropertyKey) {
    ...
    //set 时更新
    function trigger(target: object, type: string, key: PropertyKey) {
