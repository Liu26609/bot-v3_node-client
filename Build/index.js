...
function test() {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        // 属性
        image += `imageMogr2/thumbnail/!50p|watermark/2/text/${base64_safe_1.default.urlEncode(`0
1亿
150万
240十万
5.万
9998.0万`)}/font/${base64_safe_1.default.urlEncode('simkai楷体.ttf')}/fill/${base64_safe_1.default.urlEncode(`#ffffff`)}/fontsize/20/dx/10/dy/215`;
