...
class game {
    ...
    initKeyMap() {
        ...
        */
        ...
        this.matchMap.set('无尽回廊', { action: challenge_infinite_1.challenge_infinite, match: matchType.match });
        this.matchMap.set('强者挑战', { action: challenge_downUser_1.challenge_downUser, match: matchType.match });
        ...
        this.matchMap.set('仓库', { action: store_look_1.store_look, match: matchType.all });
        this.matchMap.set('取', { action: store_get_1.store_get, match: matchType.match });
        this.matchMap.set('存装备', { action: store_save_equip_1.store_save_equip, match: matchType.match });
        ...
        this.matchMap.set('设置显示伤害日志', { action: setUp_1.setUp, match: matchType.match, isShowMatch: false });
        ...
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this.speedLockMap.has(userId)) {
                ...
                if (Date.now() - lastSendTime <= 300) {
                    bot_1.default.sendText(fromChannel, `检测到消息太过频繁,请稍等2秒`);
                    return;
                }
            }
