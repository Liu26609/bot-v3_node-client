...
class shop_back_buy extends task_base_1.task_base {
    constructor(...a) {
        super(...a);
        this.render();
    }
    render() {
        return __awaiter(this, void 0, void 0, function* () {
            let req = yield sever_1.default.callApi('shop/Shop_back_buy', { userId: this.userId });
            if (!req.isSucc) {
...
exports.shop_back_buy = shop_back_buy;
