...
class me_attribute extends task_base_1.task_base {
    ...
    renderImage(data, info) {
        ...
        image.fill("#ffffff");
        let randomShowId = common_1.default.random(1, 967);
        let showId = common_1.default.random(1, 967);
        ...
        // 称号图片
        image.draw(`image Over 70,240, 0, 0 "./image/title/1 (${common_1.default.random(52, 353)}).png"`);
        // NorthWest
